...
%
%   USAGE:
%       clusters = clusterTest(s1, s2);                                                     % minimal inputs/outputs
%       [clusters, pSig, tSumsSig] = clusterTest(s1, s2, alphaThresh, alphaFA, nperm);      % full inputs/outputs
...
% HH 08/2023
%
function [clusters, pSig, tSumsSig] = clusterTest2D(s1, s2, alphaThresh, alphaFA, nperm)
